...
from .views import (SaleListAPIView, SaleRetrieveUpdateDestroyAPIView, paymentRequest, ProductListAPIView, paymentRequestConfirmation, confirmDelivery, refund)
